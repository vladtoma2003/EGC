...
void Lab2::Init()
{
...

    {
        vector<VertexFormat> vertices2
        {
            ...
            VertexFormat(glm::vec3(0.5f, 0.75f,  0.5f), glm::vec3(1, 1, 1))
            /*VertexFormat(glm::vec3(0, -2,  0), glm::vec3(0, 1, 0)),
        ...
        CreateMesh("piramid", vertices2, indices2);
    }    
    ...
    vector<VertexFormat> vertices3 {
        ...
        VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0.5, 1)),
        VertexFormat(glm::vec3(1, 0,  1), glm::vec3(1, 0.5, 1)),
        VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 0.5, 1)),
    };
    vector<unsigned int> indices3 = {
        0, 1, 3,
        1, 3, 2
    };
    CreateMesh("patrat dinala", vertices3, indices3);
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2, 1, 2), glm::vec3(0.3f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["piramid"], shaders["VertexColor"], glm::vec3(2, 0, 0), glm::vec3(1));
    
    // TODO(student): Draw the square
    RenderMesh(meshes["patrat dinala"], shaders["VertexColor"], glm::vec3(3, 0, 3), glm::vec3(1));
