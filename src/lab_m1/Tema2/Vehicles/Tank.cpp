...
void Tank::renderTank(implemented::CameraTema *camera, glm::mat4 projectionMatrix, std::unordered_map<std::string, Shader *> shaders,float time)
{
    { // Body
        ...
        Meshes::RenderSimpleMesh(getComponent("body"), shaders["LabShader"], modelMatrix,
            color, camera, hp, projectionMatrix, body->getDeformationDirection());
    }
    { // Track Left
        glm::mat4 modelMatrix = glm::mat4(1);
        ...
        Meshes::RenderSimpleMesh(getComponent("track"), shaders["LabShader"], modelMatrix,
            glm::vec3(50.f/255, 50.f/255, 50.f/255), camera, hp, projectionMatrix, tracks[0]->getDeformationDirection());
    }
    { // Track Right
        glm::mat4 modelMatrix = glm::mat4(1);
        ...
        Meshes::RenderSimpleMesh(getComponent("track"), shaders["LabShader"], modelMatrix,
            glm::vec3(50.f/255, 50.f/255, 50.f/255), camera, hp, projectionMatrix, tracks[1]->getDeformationDirection());
    }
    { // Turret
        glm::mat4 modelMatrix = glm::mat4(1);
        ...
        Meshes::RenderSimpleMesh(getComponent("turret"), shaders["LabShader"], modelMatrix,
            color + glm::vec3(15.f/255, 10.f/255, 20.f/255), camera, hp, projectionMatrix, turret->getDeformationDirection());
    }
    { // Cannon
        glm::mat4 modelMatrix = glm::mat4(1);
        ...
        Meshes::RenderSimpleMesh(getComponent("cannon"), shaders["LabShader"], modelMatrix,
            glm::vec3(50.f/255, 50.f/255, 50.f/255), camera, hp, projectionMatrix, cannon->getDeformationDirection());
    }
    { // Projectiles
        for(auto projectile:projectiles)
        {
            ...
            Meshes::RenderSimpleMesh(getComponent("projectile"), shaders["LabShader"], modelMatrix,
                glm::vec3(1,1,1), camera, 100, projectionMatrix, glm::vec2(0,0));
        }
    }
}
