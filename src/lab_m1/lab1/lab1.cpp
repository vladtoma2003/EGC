...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    // Render the object
    RenderMesh(meshes["box"], glm::vec3(bonusx, bonusy, bonusz), glm::vec3(0.5f));
    ...
    RenderMesh(meshes[object], glm::vec3(posx, posy, posz)); // big sphere
    //RenderMesh(meshes[object], glm::vec3(2, 0.5f, 0), glm::vec3(0.5f)); // small sphere
